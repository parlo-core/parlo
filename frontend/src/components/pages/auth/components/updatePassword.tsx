...
import { type UpdatePasswordFormTypes, type UpdatePasswordPageProps, useActiveAuthProvider, type BaseRecord, type HttpError, useTranslate, useUpdatePassword } from "@refinedev/core";
