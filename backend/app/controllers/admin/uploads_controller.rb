  ...
  class UploadsController < BaseController
    ...
    def presigned_url
      ...
      unless ALLOWED_FILE_TYPES.include?(file_type)
        return method_not_allowed_error(code: 'invalid_extension')
      end

      if file_size > MAX_FILE_SIZE
        return method_not_allowed_error(code: 'invalid_file_size')
      end
      ...
      render json: { url: url, file_url: object.public_url }, status: :ok
    end
  end
end
